...
<html>
	...
	<body>
		<div class="login_top">
			<a href="booklist.jsp" target="_blank"><img class="logo"
			...
			<form name="ctl00" method="post" action="register" id="f">
				...
				<table class="tab_login">
					...
					<tr>
						...
						<td>
							<input type="text" name="nickname" id="txtNickName" class="text_input">
							<span id="nameInfo" style="color: red"></span>
							<div class="text_left" id="nickNameValidMsg">
								<p>
									您的昵称可以由小写英文字母、中文、数字组成，长度4－20个字符。
								</p>
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<img class="yzm_img" align="middle" id="validateImage"
								src="image" width="150" height="40"
								onclick="this.src='image?time-'+(new Date()).getTime();" />
							<input type="text" name="validateCode" id="validateCode"
								class="yzm_input">
							<div class="text_left t1">
								<p class="t1">
									<span id="vcodeValidMsg">请输入图片中的验证码。&nbsp</span>
									<a href="javascript:"
										onclick="document.getElementById('validateImage').src='image?time-'+(new Date()).getTime();">看不清，再换一张</a>
								</p>
