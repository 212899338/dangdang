<%@page import="java.util.ArrayList,com.tedu.bean.Book" pageEncoding="utf-8" contentType="text/html; charset=utf-8"%>
		...
		<div class="book">
			...
			<div class="book_center">
				...
				<div id="divRight" class="list_right">
					...
					<div class="clear"></div>
	<!--在jsp页面中 out request response 是内置对象  可以直接用-->
	<%
		ArrayList<Book> books = (ArrayList<Book>)request.getAttribute("bs");
			...
			%>
					<div class="list_r_list">
						...
						<h6>
							...
							<span class="red">当当价:<%=b.dangPrice %></span> 节省：￥<%=b.fixedPrice - b.dangPrice %>
						</h6>
